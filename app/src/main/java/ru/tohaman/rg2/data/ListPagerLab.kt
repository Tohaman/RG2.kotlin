...
class ListPagerLab private constructor(context: Context){
    ...
    init { // тут пишем то, что выполнится при инициализации синглета
        ...
        phaseInit("OLLTEST", R.array.oll_test_phases, R.array.oll_icon,R.array.oll_test_descr,R.array.oll_test_url,context)
        phaseInit("OLLTEST_CUSTOM", R.array.oll_test_phases, R.array.oll_icon,R.array.oll_test_descr,R.array.oll_test_url,context)
